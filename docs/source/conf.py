...
# -*- coding: utf-8 -*-
#
# lexcube documentation build configuration file
#
...
project = 'lexcube'
copyright = '2022, Maximilian Söchting'
author = 'Maximilian Söchting'
...
_version_py = os.path.join(repo, 'lexcube', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'lexcube.tex', 'lexcube Documentation',
     'Maximilian Söchting', 'manual'),
]
