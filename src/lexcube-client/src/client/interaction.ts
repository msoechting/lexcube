...
class CubeInteraction {
    ...
    private updateDatasetInfoAndShow(updateParameterInfo: boolean = true, showPopup: boolean = false) {
        ...
        if (!this.context.widgetMode) {
            cornerLineSmall(`<p xmlns:cc="http://creativecommons.org/ns#" xmlns:dct="http://purl.org/dc/terms/" style="margin:5px 0px 0px 0px;">Images generated by <a property="dct:title" rel="cc:attributionURL" target="_blank" href="https://www.lexcube.org">LexCube - Leipzig Explorer of Earth Data Cubes</a> by <a rel="cc:attributionURL dct:creator" property="cc:attributionName" target="_blank" href="https://rsc4earth.de/authors/msoechting/">Maximilian Söchting</a> are licensed under <a href="http://creativecommons.org/licenses/by/4.0/?ref=chooser-v1" target="_blank" rel="license noopener noreferrer" style="display:inline-block;">CC BY 4.0<img style="height:12px!important;margin-left:3px;vertical-align:text-bottom;" src="https://mirrors.creativecommons.org/presskit/icons/cc.svg?ref=chooser-v1"><img style="height:12px!important;margin-left:3px;vertical-align:text-bottom;" src="https://mirrors.creativecommons.org/presskit/icons/by.svg?ref=chooser-v1"></a></p>`)
        }
        ...
        dialogParameterValue(`When using Lexcube-generated images, please acknowledge/cite: M. Söchting, M. D. Mahecha, D. Montero and G. Scheuermann, "Lexcube: Interactive Visualization of Large Earth System Data Cubes," in IEEE Computer Graphics and Applications, doi: https://www.doi.org/10.1109/MCG.2023.3321989.`)
